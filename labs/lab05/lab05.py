...
def replace_loki_at_leaf(t, lokis_replacement):
    ...
    if is_leaf(t) and label(t) == "loki":
        ...
        bs = [replace_loki_at_leaf(b,lokis_replacement) for b in branches]
...
def distance(city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    lat_1 ,lat_2= get_lat(city_a), get_lon(city_a)
    lon_1 ,lon_2= get_lon(city_b), get_lon(city_b)
...
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    new_city = make_city('xxx',lat,lon)
